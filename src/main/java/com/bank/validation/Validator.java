...
public static boolean validPassword(String password) {//tests entered user from getAPassword() String method4-32 chars, upper/lower case letters, special chars, numbers 
	                                                  // and no consecutive letters
